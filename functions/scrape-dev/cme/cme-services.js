...
const CME_COMMODITIES_HOST = "https://www.theglobaleconomy.com"
const CME_FEDWATCH_TOOL = CME_COMMODITIES_HOST + "/markets/interest-rates/cme-fedwatch-tool.html"
...
async function getFedRateProbabilites() {
    console.log("getFedRateProbabilites")
    const $ = getContent(CME_FEDWATCH_TOOL)


}
module.exports = {
    getFedRateProbabilites,
}
