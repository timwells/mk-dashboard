...
async function listSectorPeformance2() {
    console.log("listSectorPeformance2")
    const $ = await getContent('https://investing.thisismoney.co.uk/share-performance?source=UKX&view=financial-ratios')

    const tableRows = $('.performance__table > tr');
